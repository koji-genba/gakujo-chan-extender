...
## 2段階認証自動入力
2023/3/1に導入された対して存在意義がないのに手間だけはかかる認証コードによる2段階認証を自動化します．  
...
鍵の設定にミスがないのに認証エラーが出ているときはコンソールログ吐き出された6桁コードと認証アプリ側の6桁コードが一致しているか確認してください．もし不一致であればここにissue投げるかtwitterで@koji_genbaに連絡してください．twitterは鍵なんでFF外の人はここでissue投げるほうが楽だと思います．
